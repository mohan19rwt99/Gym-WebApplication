    ...
    return (
        <>
            <div className="flex-1 flex flex-col items-center justify-start p-6 overflow-y-auto h-full">
                <h1 className='text-4xl font-bold text-gray-800'>Add Staff</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                    ...
                    {gyms.map((gym) => (
                        ...
                        >
                            ...
                            {/* button Add Staff */}
                            <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-300 rounded-lg hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-5"
