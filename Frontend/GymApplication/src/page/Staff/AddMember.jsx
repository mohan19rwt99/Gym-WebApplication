...
function AddMember() {
    ...
    const submitForm = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("http://localhost:4000/api/addstaff", requestData, {
                headers: {
       ...
       <>
         <div className="min-h-screen flex items-center justify-center">
            <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
                ...
                <h3 className="text-2xl font-bold text-center mb-6">Add New Staff Member</h3>
                ...
                className="space-y-4">
                    ...
                    <div>
                        ...
                        {FormData.number && FormData.number.length !==10 && (
                            <p className='text-red-500 text-sm mt-1'>Contact Number must be exactly 10 digit</p>
                        )}
                    </div>
                    ...
                    <div>
                        <label htmlFor="number" className="block text-gray-700 font-medium mb-1">Contact Number</label>
                        <input
                            type="tel"
                            id="number"
                            name="number"
