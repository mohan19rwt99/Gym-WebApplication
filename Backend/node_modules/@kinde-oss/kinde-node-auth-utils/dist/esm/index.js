...
const splitToken$2 = (JWT) => ({
  header: JWT.split('.')[0],
  payload: JWT.split('.')[1],
  signature: JWT.split('.')[2]
});

var splitToken_1 = splitToken$2;

const base64 = base64url$2.exports;
const crypto$1 = require$$1;
const splitToken$1 = splitToken_1;

const verifyToken$1 = (JWT, pem) => {
  const { header, payload, signature } = splitToken$1(JWT);

  const verifyFunction = crypto$1.createVerify("SHA256");
...
var verifyToken_1 = verifyToken$1;

// Convert a base 64 url encoded string to a JSON object
function decodeToken$1(base64url) {
  let jsonString;
  try {
...
var decodeToken_1 = decodeToken$1;

const verifyToken = verifyToken_1;
const decodeToken = decodeToken_1;
const splitToken = splitToken_1;

const authToken$1 = (JWT, pem, callback) => {
...
try {
  ...
  inherits$a.exports = util.inherits;
} catch (e) {
  /* istanbul ignore next */
  inherits$a.exports = inherits_browser.exports;
}

/* eslint-disable node/no-deprecated-api */

var buffer$1 = require$$0$1;
var Buffer$6 = buffer$1.Buffer;

var safer = {};

var key$2;

for (key$2 in buffer$1) {
  if (!buffer$1.hasOwnProperty(key$2)) continue
  if (key$2 === 'SlowBuffer' || key$2 === 'Buffer') continue
  safer[key$2] = buffer$1[key$2];
}

var Safer = safer.Buffer = {};
for (key$2 in Buffer$6) {
  if (!Buffer$6.hasOwnProperty(key$2)) continue
  if (key$2 === 'allocUnsafe' || key$2 === 'allocUnsafeSlow') continue
  Safer[key$2] = Buffer$6[key$2];
}
...
const inherits$9 = inherits$a.exports;
...
inherits$9(ReporterError, Error);
...
inherits$8(DecoderBuffer$2, Reporter$1);
...
function EncoderBuffer$1(value, reporter) {
  if (Array.isArray(value)) {
    ...
    this.value = value;
    this.length = Buffer$5.byteLength(value);
...
EncoderBuffer$1.prototype.join = function join(out, offset) {
  if (!out)
    out = Buffer$5.alloc(this.length);
  if (!offset)
    offset = 0;
  ...
  if (Array.isArray(this.value)) {
    ...
    else if (Buffer$5.isBuffer(this.value))
...
const assert$g = minimalisticAssert;
...
Node$2.prototype._init = function init(body) {
  ...
  assert$g.equal(state.children.length, 1, 'Root node can have only one child');
};
...
Node$2.prototype.explicit = function explicit(num) {
  ...
  assert$g(state.explicit === null && state.implicit === null);
  state.explicit = num;
...
Node$2.prototype._getUse = function _getUse(entity, obj) {
  ...
  assert$g(state.useDecoder._baseState.parent === null);
...
const inherits$7 = inherits$a.exports;
const Buffer$4 = safer_1.Buffer;
const Node$1 = node;
...
DERNode$1.prototype._encodeComposite = function encodeComposite(tag,
  ...
  const header = Buffer$4.alloc(1 + 1 + lenOctets);
  header[0] = encodedTag;
...
DERNode$1.prototype._encodeStr = function encodeStr(str, tag) {
  if (tag === 'bitstr') {
    ...
    const buf = Buffer$4.alloc(str.length * 2);
...
DERNode$1.prototype._encodeObjid = function encodeObjid(id, values, relative) {
  ...
  const objid = Buffer$4.alloc(size);
...
DERNode$1.prototype._encodeInt = function encodeInt(num, values) {
  ...
  if (typeof num !== 'number' && !Buffer$4.isBuffer(num)) {
    const numArray = num.toArray();
    if (!num.sign && numArray[0] & 0x80) {
      numArray.unshift(0);
    }
    num = Buffer$4.from(numArray);
  }

  if (Buffer$4.isBuffer(num)) {
    let size = num.length;
    if (num.length === 0)
      size++;

    const out = Buffer$4.alloc(size);
    num.copy(out);
    if (num.length === 0)
      out[0] = 0;
  ...
  return this._createEncoderBuffer(Buffer$4.from(out));
};
...
const inherits$6 = inherits$a.exports;
...
const inherits$5 = inherits$a.exports;

const bignum = bn.exports;
...
const inherits$4 = inherits$a.exports;
const Buffer$3 = safer_1.Buffer;
...
PEMDecoder.prototype.decode = function decode(data, options) {
  ...
  const input = Buffer$3.from(base64, 'base64');
...
const inherits = inherits$a.exports;
...
var utils$z = utils$C;
var BN$7 = bn.exports;
var inherits$3 = inherits$a.exports;
var Base$2 = base;
...
var BN$6 = bn.exports;
var inherits$2 = inherits$a.exports;
var Base$1 = base;
...
MontCurve.prototype.decodePoint = function decodePoint(bytes, enc) {
  return this.point(utils$y.toArray(bytes, enc), 1);
};
...
var utils$x = utils$C;
var BN$5 = bn.exports;
var inherits$1 = inherits$a.exports;
var Base = base;

var assert$d = utils$x.assert;
...
var inherits = inherits$a.exports;

utils$w.inherits = inherits;
...
BlockHash$4.prototype.update = function update(msg, enc) {
  ...
  if (this.pending.length >= this._delta8) {
    ...
    msg = utils$v.join32(msg, 0, msg.length - r, this.endian);
...
utils$q.inherits(SHA512$1, BlockHash$1);
var _512 = SHA512$1;
...
utils$p.inherits(SHA384, SHA512);
var _384 = SHA384;
...
utils$o.inherits(RIPEMD160, BlockHash);
...
function Hmac(hash, key, enc) {
  ...
  this._init(utils$n.toArray(key, enc));
}
var hmac = Hmac;
...
function HmacDRBG$1(options) {
  ...
  var entropy = utils$m.toArray(options.entropy, options.entropyEnc || 'hex');
  var nonce = utils$m.toArray(options.nonce, options.nonceEnc || 'hex');
  var pers = utils$m.toArray(options.pers, options.persEnc || 'hex');
...
HmacDRBG$1.prototype.reseed = function reseed(entropy, entropyEnc, add, addEnc) {
  ...
  entropy = utils$m.toArray(entropy, entropyEnc);
  add = utils$m.toArray(add, addEnc);
...
HmacDRBG$1.prototype.generate = function generate(len, enc, add, addEnc) {
  ...
  if (add) {
    add = utils$m.toArray(add, addEnc || 'hex');
    this._update(add);
  }
  ...
  this._update(add);
  this._reseed++;
  return utils$m.encode(res, enc);
};

var BN$4 = bn.exports;
var utils$l = utils$C;
var assert$6 = utils$l.assert;
...
function EC$1(options) {
  ...
  if (typeof options === 'string') {
    assert$4(Object.prototype.hasOwnProperty.call(curves$2, options),
...
EDDSA.prototype.hashInt = function hashInt() {
  ...
  return utils$g.intFromLE(hash.digest()).umod(this.curve.n);
};
...
var BN = asn1$2.bignum,
	Buffer$2 = safeBuffer.exports.Buffer;

var b64ToBn$2 = function base64ToBigNum(val, zero) {
	var buf = Buffer$2.from(val, 'base64');
...
var algorithmIdentifier = asn1$2.define('AlgorithmIdentifer', /* @this */ function() {
	this.seq().obj(
...
var AlgorithmIdentifier$1 = algorithmIdentifier;

var publicKeyInfo = asn1$2.define('PublicKeyInfo', /* @this */ function() {
	this.seq().obj(
...
var version = asn1$2.define('Version', /* @this */ function() {
	this.int();
});
...
var privateKeyInfo = asn1$2.define('PrivateKeyInfo', /* @this */ function() {
	this.seq().obj(
		this.key('version').use(Version$2),
...
var b64ToBn$1 = b64ToBn$2;

var PublicKeyInfo$1 = publicKeyInfo,
	PrivateKeyInfo$1 = privateKeyInfo,
	Version$1 = version;

var ECParameters = asn1$1.define('ECParameters', /* @this */ function() {
	this.choice({
...
var ECPrivateKey = asn1$1.define('ECPrivateKey', /* @this */ function() {
	this.seq().obj(
		this.key('version').use(Version$1),
		this.key('privateKey').octstr(),
...
function ecJwkToBuffer(jwk, opts) {
	...
	if (hasPub) {
		key.pub = {
			x: b64ToBn$1(jwk.x, false),
			y: b64ToBn$1(jwk.y, false)
		};
	}

	if (opts.private || !hasPub) {
		key.priv = b64ToBn$1(jwk.d, true);
	}
...
function keyToPem(crv, key, opts) {
	...
	publicKey = Buffer$1.from(publicKey, 'hex');
	publicKey = {
		unused: 0,
		data: publicKey
	};
	...
	if (opts.private) {
		...
		privateKey = Buffer$1.from(privateKey, 'hex');

		result = PrivateKeyInfo$1.encode({
			version: 0,
...
var ec$1 = ecJwkToBuffer;

var asn1 = asn1$2;

var b64ToBn = b64ToBn$2;
...
const jwkToPem = jwkToPem$1;
const axios = axios$1;

const getPem$1 = async (domain) => {
...
var getPem_1 = getPem$1;

const authToken = authToken_1;
const getPem = getPem_1;

var src = {authToken, getPem};
