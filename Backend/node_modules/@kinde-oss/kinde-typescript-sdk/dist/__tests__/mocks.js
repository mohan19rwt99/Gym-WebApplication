...
var mockPrivateKey;
var mockPublicKey;
export var mockJwtAlg = 'RS256';
export var getKeys = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, generateKeyPair(mockJwtAlg)];
            case 1:
                _a = _b.sent(), generatedPublicKey = _a.publicKey, generatedPrivateKey = _a.privateKey;
                return [4 /*yield*/, exportJWK(generatedPrivateKey)];
            case 2:
                generatedPrivateJwk = _b.sent();
                return [4 /*yield*/, exportJWK(generatedPublicKey)];
            case 3:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getKeys()];
                case 1:
                    privateKey = (_a.sent()).privateKey;
                    return [4 /*yield*/, importJWK(privateKey, mockJwtAlg)];
                case 2:
                    key = _a.sent();
                    return [4 /*yield*/, new SignJWT(tokenPayload)
