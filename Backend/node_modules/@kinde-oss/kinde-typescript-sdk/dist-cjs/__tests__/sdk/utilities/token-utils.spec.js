            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, utilities_1.commitTokensToSession)(sessionManager, tokenCollection, validationDetails)];
                    case 3:
                        _d.sent();
                        _a = expect;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        commitTokenFn = function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, utilities_1.commitTokenToSession)(sessionManager, mockAccessToken, 'access_token', validationDetails)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, utilities_1.commitTokenToSession)(sessionManager, mockIdToken, 'id_token', validationDetails)];
                    case 2:
                        _c.sent();
                        return [4 /*yield*/, (0, utilities_1.getUserFromSession)(sessionManager, validationDetails)];
                    case 3:
                        storedUser = _c.sent();
                        expectedUser = {
        ...
        it('returns true if null is provided as argument', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = expect;
                        return [4 /*yield*/, (0, utilities_1.isTokenExpired)(null, validationDetails)];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        mockAccessToken = (_b.sent()).token;
                        _a = expect;
                        return [4 /*yield*/, (0, utilities_1.isTokenExpired)(mockAccessToken, validationDetails)];
                    case 2:
                        _a.apply(void 0, [_b.sent()]).toBe(true);
                        return [2 /*return*/];
                }
