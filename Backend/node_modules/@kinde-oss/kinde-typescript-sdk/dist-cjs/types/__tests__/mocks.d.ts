...
export declare const mockJwtAlg = "RS256";
export declare const getKeys: () => Promise<{
    privateKey: JWK;
    publicKey: JWK;
}>;
export declare const fetchClient: jest.Mock<any, any, any>;
export declare const getMockAccessToken: (domain?: string, isExpired?: boolean, isExpClaimMissing?: boolean) => Promise<{
    token: string;
    payload: {
        aud: string[];
        azp: string;
...
export declare const getMockIdToken: (domain?: string, isExpired?: boolean) => Promise<{
    token: string;
    payload: {
        at_hash: string;
        aud: string[];
