...
var createCCClient = function (options) {
    ...
    return __assign(__assign({}, (0, with_auth_utilities_js_1.default)(isAuthenticated, client.tokenValidationDetails)), { isAuthenticated: isAuthenticated, getToken: getToken, logout: logout });
};
